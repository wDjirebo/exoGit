...
<html lang="en">
<head>
  <title> Green Vision Group</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="row blockMenu">
      ...
      <a class="navbar-brand"> <img src="green vision group/logo.jpg" alt="logo de la société" width="200" height="100"/></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#about">A PROPOS</a></li>
        <li><a href="#domaine">INTERVENTION</a></li>
